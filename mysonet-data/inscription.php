...
if ($stmt->rowCount() > 0) {
    die("Le pseudo existe déjà. Choisissez-en un autre. Pensez à modifier aussi sur votre propre serveur.");
}
...
if ($stmt->rowCount() > 0) {
    die("L'IP existe déjà dans la liste. Vous vous êtes déjà inscrit.");
}
